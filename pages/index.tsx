    ...
    <div className="max-w-screen-xl mx-auto">
     ...
     <div className='flex justify-between items-center bg-yellow-400 border-y border-black py-10 lg:p-0'>
      <div className='px-10 space-y-5'>
        ...
        <h2>It's easy and free to post your thinking on any topic and connect with milions of readers.</h2>
      </div>

      <img className='hidden md:inline-flex h-48 lg:h-full' src="https://accountabilitylab.org/wp-content/uploads/2020/03/Medium-logo.png" alt="" />
     </div>
    </div>
  )
}
